...
const BPKP4Printout: React.FC<BPKP4PrintoutProps> = ({ report }) => {
  ...
  const renderJenisKerjaHeader = () => {
    return (
      <p className="mt-1 font-bold text-[10px] uppercase tracking-tight">
        KERJA : {' '}
    ...
    <div className="bg-white mx-auto max-w-[210mm] text-black font-serif leading-tight print:p-0">
      ...
      <div className="min-h-[297mm] flex flex-col relative px-10 py-6 border-b-2 border-dashed border-slate-200 print:border-none print:min-h-screen">
        ...
        <div className="relative mb-2">
          ...
          <div className="text-center font-bold text-[11px]">A - 1</div>
        ...
        <div className="grid grid-cols-2 border-2 border-black divide-x-2 divide-black mb-4">
          <div className="p-2 space-y-2 min-h-[160px] text-[10.5px]">
            ...
            <p className="text-[8.5px] italic leading-none pl-4">(Kecemasan, Darurat, Dirancang)</p>
            <div className="pt-4">
        ...
        {/* Signature & Stamp Row */}
        <div className="grid grid-cols-2 border-x-2 border-b-2 border-black mb-4 min-h-[140px]">
        ...
        {/* Table */}
        <div className="text-center font-bold mb-1 text-[11px] uppercase underline underline-offset-4 decoration-1">BUTIR-BUTIR KERJA +</div>
        <table className="w-full border-collapse border-2 border-black text-[10.5px]">
          <thead>
            <tr>
              <th className="border-2 border-black p-1 w-12 uppercase text-center">Bil</th>
              <th className="border-2 border-black p-1 w-1/3 uppercase text-left">No bangunan Jenis Prasarana</th>
              <th className="border-2 border-black p-1 uppercase text-left">Butiran Kerja</th>
              <th className="border-2 border-black p-1 w-24 uppercase text-center">Catatan</th>
            </tr>
            <tr className="text-[9px] h-4 text-center">
          ...
          <tbody>
            {report.items.map((item, i) => (
              <tr key={item.id}>
                ...
                <td className="border-2 border-black p-1 uppercase font-bold align-top leading-tight min-h-[40px]">{item.noBangunan}</td>
                <td className="border-2 border-black p-1 uppercase align-top leading-tight">{item.butiranKerja}</td>
                <td className="border-2 border-black p-1 text-[9.5px] align-top">{item.catatan || '-'}</td>
              </tr>
            ))}
            {/* Rows to fill space but keep Bahagian A on same page */}
            {Array.from({ length: Math.max(0, 4 - report.items.length) }).map((_, i) => (
        ...
        <div className="mt-4 space-y-3">
          <h3 className="font-bold text-[10.5px] uppercase">A. PENGESAHAN OLEH PENGAWAS SENGGARAAN</h3>
          <p className="indent-10 text-[10.5px] leading-relaxed text-justify">
          ...
          <div className="flex justify-between items-end pt-2 text-[10.5px]">
        ...
        <div className="mt-auto pt-4 text-center">
          <div className="font-bold text-[11px]">A - 1</div>
      ...
      <div className="min-h-[297mm] flex flex-col relative px-10 py-6 print:break-before-page border-b-2 border-dashed border-slate-200 print:border-none print:min-h-screen">
        <div className="text-center font-bold uppercase text-[11px]">TERHAD</div>
        <div className="text-center font-bold text-[11px] mb-6">A - 2</div>
        ...
        <div className="flex-1 space-y-10">
          <section>
            ...
            <p className="mt-3 leading-relaxed text-[11px]">Kontraktor ____________________________________________________ dikehendaki melaksanakan pembaikan ini dan hendaklah disiapkan pada ____________________.</p>
            <div className="flex justify-between items-end mt-6 text-[10.5px]">
          ...
          <section>
            ...
            <p className="mt-3 leading-relaxed text-[11px] text-justify">Saya __________________________________ daripada Syarikat __________________________________ bersetuju melaksanakan kerja ini dengan sempurna dan menggunakan bahan-bahan terbaik. Saya bersetuju keputusan Pegawai Senggaraan BPKP/UPKAT mengenai skop kerja, bahan yang digunakan dan harga yang akan dibayar adalah muktamad. Pembayaran mungkin berbeza dari yang dianggarkan mengikut kerja yang benar-benar dilaksanakan.</p>
            <div className="flex justify-between items-end mt-6 text-[10.5px]">
          ...
          <section>
            ...
            <p className="mt-3 leading-relaxed text-[11px] text-justify">Saya sahkan yang kerja-kerja di atas/seperti dikepilkan telah diperiksa dan didapati memuaskan. Kerja bermula pada ____________________ dan siap pada ____________________. Saya dengan ini menyokong kontraktor dibayar sejumlah RM ____________________ bagi kerja-kerja tersebut.</p>
            <div className="flex justify-between items-end mt-6 text-[10.5px]">
              <p className="font-bold">Tarikh : ____________________</p>
              <div className="text-right space-y-1">
                <p className="font-bold">Tandatangan : __________________________</p>
          ...
          {/* Correct Notes */}
          <div className="pt-8 space-y-1 text-[10px] font-bold border-t border-black/10">
        ...
        {/* Footer Page 2 */}
        <div className="mt-auto pt-4 text-center">
          <div className="font-bold text-[11px]">A - 2</div>
          <div className="font-bold text-[11px] uppercase">TERHAD</div>
        </div>
      </div>
      ...
      <div className="min-h-[297mm] flex flex-col relative px-10 py-6 print:break-before-page print:min-h-screen">
        <div className="text-center font-bold uppercase text-[11px]">TERHAD</div>
        <div className="text-center font-bold text-[11px] mb-6">A - 3</div>

        <div className="flex-1">
           <h3 className="font-bold text-center underline uppercase mb-8 text-[11px] tracking-widest decoration-1">LAMPIRAN GAMBAR BUKTI KEROSAKAN (4 SUDUT)</h3>
           <div className="grid grid-cols-2 gap-8">
              <div className="border border-black p-2 text-center bg-white flex flex-col">
                <img src={report.images.sisi1} className="w-full h-64 object-cover grayscale brightness-110 border border-black mb-2" alt="Sisi 1" />
                <p className="font-bold uppercase text-[9px]">Lampiran 1: Sudut Pandangan Sisi Kanan</p>
              </div>
              <div className="border border-black p-2 text-center bg-white flex flex-col">
                <img src={report.images.sisi2} className="w-full h-64 object-cover grayscale brightness-110 border border-black mb-2" alt="Sisi 2" />
                <p className="font-bold uppercase text-[9px]">Lampiran 2: Sudut Pandangan Sisi Kiri</p>
              </div>
              <div className="border border-black p-2 text-center bg-white flex flex-col">
                <img src={report.images.keseluruhan} className="w-full h-64 object-cover grayscale brightness-110 border border-black mb-2" alt="Keseluruhan" />
                <p className="font-bold uppercase text-[9px]">Lampiran 3: Sudut Pandangan Keseluruhan</p>
              </div>
              <div className="border border-black p-2 text-center bg-white flex flex-col">
                <img src={report.images.closeup} className="w-full h-64 object-cover grayscale brightness-110 border border-black mb-2" alt="Close-up" />
                <p className="font-bold uppercase text-[9px]">Lampiran 4: Sudut Pandangan Fokus (Close-up)</p>
              </div>
           </div>
        </div>
        ...
        {/* Footer Page 3 */}
        <div className="mt-auto pt-4 text-center">
          <div className="font-bold text-[11px]">A - 3</div>
          <div className="font-bold text-[11px] uppercase">TERHAD</div>
        </div>
      </div>
    </div>
